...
insert into recipe (id, name, description, url, category_Id) values (2, 'Pyszne pączki', 'Ricottę miksujemy z jajkami. Dodajemy mąkę, proszek do pieczenia, cukier i znów miksujemy na gładko. Rozgrzewamy olej. Lyżeczką kładziemy partiami ciasto na tłuszcz, zachowując odstępy. Smażymy z obu stron na złoto.', 'https://tygodniksanocki.pl/wp-content/uploads/2019/02/p%C4%85czki-seria-e1550845827925.jpg', 4);
